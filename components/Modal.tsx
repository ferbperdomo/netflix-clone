...
function Modal() {
    ...
    return <MuiModal open={showModal} onClose={handleClose} className="fixed !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md scrollbar-hide" >
        <>
            ...
            <div className='relative pt-[56.25%]'>
                <ReactPlayer
                    url={trailer === undefined ? "https://www.youtube.com/watch?v=y-67bCRIrg4" : `https://www.youtube.com/watch?v=${trailer}`}
                    width="100%"
                    height="100%"
